              ...
              >
                <div id="registration-form" className="bg-gradient-to-br from-gray-800/90 to-gray-900/90 rounded-2xl shadow-2xl p-8 border border-gray-700">
                  ...
                  <p className="text-gray-400 text-center mb-8">
                    Remplissez le formulaire et vous serez contacté par notre
                    equipe pour rejoindre la formation.
                  </p>
                  ...
                  <div className="mt-6 text-center text-sm text-gray-400">
                    <div className="flex items-center justify-center gap-2 mb-2">
                      <FaLock className="w-4 h-4" />
                      <span>
                        Vos données sont sauvegardées et confidentielles
                      </span>
                    </div>
                    <div className="flex items-center justify-center gap-2">
                      <FaClock className="w-4 h-4" />
              ...
              <div className="mb-8">
                ...
                <div className="grid gap-4">
                  ...
                  >
                    <span className="text-blue-400 text-xl">✨</span>
                    <span className="text-gray-300">
                      Collaborer avec des transitaires de confiance
                    </span>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: -20 }}
                  ...
                  >
                    <span className="text-blue-400 text-xl">✨</span>
                    <span className="text-gray-300">
                      Profiter d'un accompagnement à vie !
                    </span>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: -20 }}
                  ...
                  >
                    <span className="text-blue-400 text-xl">✨</span>
                    <span className="text-gray-300">
                      Intégrer une communauté d'e-commerçants dynamiques et
                      actifs
                    </span>
                  </motion.div>
                </div>
              ...
              <div>
                ...
                <div className="grid gap-4">
                  ...
                  >
                    ...
                    <span className="text-gray-300">
                      Accès aux meilleurs contacts en Chine pour vos besoins
                    </span>
                  </motion.div>
                  <motion.div
                    initial={{ opacity: 0, x: -20 }}
                  ...
                  >
                    <span className="text-green-500">✔️</span>
                    <span className="text-gray-300">
                      Apprentissage pratique et astuces exclusives
                    </span>
                  </motion.div>
                </div>
              </div>
